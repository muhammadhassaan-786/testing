        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={index} className="rounded-xl p-6 border border-gray-200 flex items-center gap-4 bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="rounded-2xl p-8 border border-gray-200 text-center bg-white">
